/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/sjames/sojan/playground/crosstool-ng/crosstool-ng/.build/aarch64-unknown-linux-gnu/src/gcc/gcc/config/aarch64/aarch64.md'.  */
